...
_REQUIRED_MODULES = ("fastapi", "pydantic", "kernel_v34", "kernel_v35")
_MISSING = [m for m in _REQUIRED_MODULES if find_spec(m) is None]
if _MISSING:
    missing = ", ".join(_MISSING)
    raise ModuleNotFoundError(
        f"whiteswan_api_v35 requires missing modules: {missing}. "
        "Install the WhiteSwan kernel/runtime dependencies before starting this API."
    )
